...
var checkTables = function () {
    return Promise.all([DB.tableExists("class"), DB.tableExists("student"), DB.tableExists("classesStudents"), DB.from("schema_info").selectMap("version")]).chain(function (res) {
