...
var Class = patio
    .addModel("class")
    .manyToMany("students", {leftKey: "classKey", rightKey: "studentKey"})
    .manyToMany("aboveAverageStudents", {model: "student", leftKey: "classKey", rightKey: "studentKey"}, function (ds) {
        return ds.filter({gpa: {gte: 3.5}});
    })
    .manyToMany("averageStudents", {model: "student", leftKey: "classKey", rightKey: "studentKey"}, function (ds) {
        return ds.filter({gpa: {between: [2.5, 3.5]}});
    })
    .manyToMany("belowAverageStudents", {model: "student", leftKey: "classKey", rightKey: "studentKey"}, function (ds) {
...
var Student = patio
    ...
    .manyToMany("classes", {leftKey: "studentKey", rightKey: "classKey"});
...
function setup() {
    return db
        ...
        .then(function () {
            return db.createTable("classesStudents", function () {
