...
var Migrator = define({
    ...
    "static": {
        ...
        run: function (db, directory, opts, cb) {
            ...
            opts = opts || {};
            return p.nodeify(this.__getMigrator(directory).then(function (Migrator) {
    ...
    instance: {
                                        ...
                                        return DB
                                            .transaction(function () {
                                                if (!isFunction(migration[direction])) {
                                                    ...
                                                    return p.resolveOrPromisfyFunction(migration[direction], void 0, DB)
                                                        .then(function () {
                                                            return self._setMigrationVersion(lv);
                                                        });
                                                }
        ...
        _getMigrationFiles: function () {
            if (!this._migrationFiles) {
                ...
                return p.resolve(this._migrationFiles);
            }
        },

        _getLatestMigrationVersion: function () {
            if (!isUndefined(this._opts.target)) {
                return p.resolve(this._opts.target);
            } else {
                var self = this;
                return this._getMigrationFiles().then(function (files) {
        ...
        _getCurrentMigrationVersion: function () {
            if (!isUndefined(this._opts.current)) {
                return p.resolve(this._opts.current);
            } else {
        ...
        _getSchemaDataset: function () {
            ...
            if (!this.__schemaDataset) {
                ...
                return p.resolve(this.__schemaDataset);
            }
        },
    ...
    instance: {
                    ...
                    return asyncArray(migrations).forEach(function (curr) {
                        ...
                        return DB.transaction(function () {
                            ...
                            if (!isFunction(migration[direction])) {
                                ...
                                return p.resolveOrPromisfyFunction(migration[direction], void 0, DB).then(function () {
                                    return (direction === "up" ? ds.insert(query) : ds.filter(query).remove());
                                });
                            }
                        }).then(function () {
        ...
        __getAppliedMigrations: function () {
            if (!this.__appliedMigrations) {
                var self = this;
                return this._getSchemaDataset().then(function (ds) {
                    return p.all([ds.selectOrderMap(self.column), self.getFileNames()])
                        .then(function (res) {
                ...
                return p.resolve(this.__appliedMigrations);
            }
        },
        ...
        __getMigrationFiles: function () {
            ...
            if (!this.__migrationFiles) {
                return p.all([this.getFileNames(), this.__getAppliedMigrations()])
                    .then(function (res) {
                ...
                return p.resolve(this.__migrationFiles);
            }
        },
        ...
        __createTable: function () {
            ...
            var ds = this.db.from(table), self = this;
            return p.all([db.tableExists(table), db.tableExists(intMigrationTable)])
                .then(function (res) {
