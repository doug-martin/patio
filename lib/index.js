...
var Patio = singleton([EventEmitter, Time], {
    instance: {
         ...
         * @return {Promise} a promise that is resolved once all databases have disconnected.
         */
        disconnect: function (cb) {
            var self = this;
            return Database.disconnect(cb)
                .then(function () {
         ...
         * @return {Promise} a promise that will be resolved when the models have been synced.
         */
