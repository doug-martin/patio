...
module.exports = define(null, {
    instance: {
        ...
        tableExists: function (table, cb) {
            return nodeify(this.from(table).first().then(function () {
                return true;
            }, function () {
                return false;
            }), cb);
            ...
            ["transaction", "execute"].forEach(function (n) {
                ...
                this[n] = function (arg1, arg2) {
                    ...
                    if (comb.isInstanceOf(ret, stream.Stream)) {
                        ...
                        promises.push((ret = Promise.resolve(ret)));
                    }
                    return ret;
                };
            }, this);
        ...
        __getTransactionConnection: function (conn) {
            var self = this;
            return conn ? Promise.resolve(conn) : this._getConnection().then(function (conn) {
