...
module.exports = define({
    instance: {
        ...
        alterTable: function (name, generator, block) {
            ...
            var self = this;
            return this.__alterTableSqlList(name, generator.operations).then(function (res) {
                return asyncArray(res)
                    .flatten()
        ...
        createTable: function (name, options, block) {
            ...
            return this.__createTableFromGenerator(name, generator, options).then(function () {
        ...
        forceCreateTable: function (name, options, block) {
            ...
            return this.dropTable(name).then(doCreate, doCreate);
        },
        ...
        createTableUnlessExists: function (name, options, block) {
            var self = this;
            return this.tableExists(name).then(function (exists) {
                if (!exists) {
                    return self.createTable(name, options, block);
                }
            });
        ...
        createOrReplaceView: function (name, source, opts) {
            ...
            opts.replace = true;
            var self = this;
            return this.executeDdl(this.__createViewSql(name, source, opts)).then(function () {
                return self.removeCachedSchema(name);
            });
        },
        ...
        dropTable: function (names) {
            ...
            return asyncArray(names).forEach(function (name) {
                return self.executeDdl(self.__dropTableSql(name)).then(function () {
                    return self.removeCachedSchema(name);
                });
            }, 1);
        },
        ...
        forceDropTable: function (names) {
            ...
            var l = names.length, self = this;
            return new p.Promise(function (resolve) {
                (function drop(i) {
                    if (i < l) {
                        var name = names[i++];
                        self.executeDdl(self.__dropTableSql(name)).then(function () {
        ...
        dropView: function (names, opts) {
            if (isArray(names)) {
                opts = opts || {};
                var self = this;
                return asyncArray(names)
                    .forEach(function (name) {
                        return self
                            .executeDdl(self.__dropViewSql(name, opts))
                            .then(function () {
                                self.removeCachedSchema(name);
                            });
                    }, null, 1)
        ...
        renameTable: function (name, newName) {
            var self = this;
            return this.executeDdl(this.__renameTableSql(name, newName)).then(function () {
                self.removeCachedSchema(name);
            });
        ...
        __alterTableSql: function (table, op) {
            ...
            case "setColumnNull":
                ...
                break;
            case "addIndex":
                return p.resolve(this.__indexDefinitionSql(table, op));
            case "dropIndex":
                return p.resolve(this.__dropIndexSql(table, op));
            case "addConstraint":
            ...
            case "dropConstraint":
                ...
                break;
            default :
                return p.reject(new DatabaseError("Invalid alter table operator '" + op.op + "'"));
            }
            return p.resolve(format("ALTER TABLE %s %s", this.__quoteSchemaTable(table), alterTableOp));
        },
        ...
        __alterTableSqlList: function (table, operations) {
            var self = this;
            return p.all(operations.map(function (operation) {
        ...
        __createTableIndexesFromGenerator: function (name, generator, options) {
            ...
            if (promises.length) {
                ret = p.all(promises).then(function (res) {
                    return res;
                }, function (err) {
                    if (!e) {
                        throw err;
         ...
         */
        __typeLiteralGenericBlob: function () {
            return "blob";
        },
         ...
         */
        __typeLiteralGenericDateTime: function () {
            return "datetime";
        },
         ...
         */
        __typeLiteralGenericTimestamp: function () {
            return "timestamp";
        },
         ...
         */
        __typeLiteralGenericTime: function () {
            return "time";
        },
         ...
         */
        __typeLiteralGenericYear: function () {
            return "year";
        },
         ...
         * @private
         */
        __typeLiteralGenericFloat: function () {
         ...
         * @private
         */
        __typeLiteralGenericDecimal: function () {
            return "double precision";
        },
         ...
         * @private
         */
        __typeLiteralGenericJson: function () {
            return "json";
        },
