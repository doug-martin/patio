...
var QueryPlugin = exports.QueryPlugin = comb.define(null, {
    instance: {
         ...
         * });
         *
         * @return {Promise} resolved with the model instance.
         */
        __reload: function () {
            if (!this.__isNew) {
                var self = this;
                return this.dataset.naked().filter(this._getPrimaryKeyQuery()).one().then(function (values) {
         ...
         * removing the model.
         *
         * @return {Promise} called back after the deletion is successful.
         */
        ...
        _saveReload: function (options) {
            ...
            return reload ? this.__reload() : p.resolve(this);
        },
         ...
         *
         * @return {Promise} resolved when the update action has completed.
         */
         ...
         *
         * @return {Promise} resolved when the save action has completed.
         */
    ...
    static: {
         ...
         *
         * @return {Promise} called back with the record or null if one is not found.
         */
        ...
        findOrCreate: function (q) {
            var self = this;
            return this.find(q).then(function (res) {
         ...
         *
         * @return {Promise} called back when the removal completes.
         */
        ...
        removeById: function (id, options) {
            var self = this;
            return this._checkTransaction(options, function () {
                return self.findById(id).then(function (model) {
         ...
         * saving the models.
         *
         * @return {Promise} called back with the saved record/s.
         */
