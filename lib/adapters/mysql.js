    ...
    instance: {
        ...
        query: function (query) {
            ...
            if (!this.closed) {
                ...
                ret = Promise.reject(new Error("Connection already closed"));
            }
            return ret;
        }
    }
...
DB = exports.MySQLDatabase = Database.extend( {
    instance: {
        ...
        validate: function (conn) {
            return Promise.resolve(!(conn.errored));
        },
        ...
        serverVersion: function () {
            ...
            if (!this.__serverVersion) {
                ...
                ret = Promise.resolve(this._serverVersion);
            }
            return ret;
        },
        ...
        __alterTableSql: function (table, op) {
            ...
            if (op.op === "addColumn") {
                ...
                ret = Promise.resolve(format("%s ON %s", this.__dropIndexSql(table, op), this.__quoteSchemaTable(table)));
            } else {
                ret = this._super(arguments);
            }
            return ret;
