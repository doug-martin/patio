    ...
    instance: {
        ...
        constructor: function (options) {
            ...
            if (!options.createConnection || !isFunction(options.createConnection)) {
                throw new Error("patio.ConnectionPool : create connection CB required.");
            }
            if (!options.closeConnection || !isFunction(options.closeConnection)) {
                throw new Error("patio.ConnectionPool : close connection CB required.");
            }
         ...
         *
         * @return {Promise} A promise resolved with a connection.
         */
        getConnection: function () {
            ...
            return new p.Promise(function (resolve, reject) {
                ...
                if (self.count > self.__maxObjects && !conn) {
                    reject(new Error("Unexpected patio.ConnectionPool error"));
                }
            });
        },
         ...
         *
         * @return {Promise} A Promise resolved when all connections are closed.
         */
        endAll: function () {
            this.__ending = true;
         ...
         *
         * @return {Promise} A Promise resolved when the connection is closed.
         */
