        ...
        graph: function (dataset, joinConditions, options, block) {
            ...
            if (isUndefinedOrNull((graph = opts.graph))) {
                ...
                if (addColumns) {
                    ...
                    populateGraphPromise = this.columns.then(function (cols) {
                    ...
                    populateGraphPromise = Promise.resolve(graph);
                }
            } else {
                populateGraphPromise = Promise.resolve(graph);
            }
            return populateGraphPromise.then(function (graph) {
                var ret;
