    ...
    instance: {
        ...
        constructor: function () {
            ...
            this._static.CONDITIONED_JOIN_TYPES.forEach(function (type) {
                if (!self[type + "Join"]) {
                    self[type + "Join"] = hitch(self, self.conditionedJoin, type);
                }

            });
            this._static.UNCONDITIONED_JOIN_TYPES.forEach(function (type) {
                if (!self[type + "Join"]) {
                    self[type + "Join"] = hitch(self, self.unConditionJoin, type);
                }
        ...
        group: function (columns) {
            ...
            var self = this;
            return this.mergeOptions({
                group: (array.compact(columns).length === 0 ? null : columns.map(function (c) {
         ...
         */
        lte: function (arr) {
            arr = this.__arrayToConditionSpecifier(argsToArray(arguments), "lte");
            return this.filter(this.__createBoolExpression("lte", arr));
        },
        ...
        compoundClone: function (type, dataset, options) {
            var ds = this._compoundFromSelf().mergeOptions({
                compounds: (array.toArray(this.__opts.compounds || [])).concat([
