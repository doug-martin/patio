    ...
    it.describe("patio.adapters.Mysql", function (it) {
        ...
        it.beforeAll(function () {
            ...
            return new Promise(function (resolve) {
                return MYSQL_DB.forceCreateTable("test2", function () {
                    this.name("text");
                    this.value("integer");
                }).then(forceDrop("items"), forceDrop("items"))
                    .then(forceDrop("dolls"), forceDrop("dolls"))
                    .then(forceDrop("booltest"), forceDrop("booltest"))
        ...
        it.describe("#createTable", function (it) {
            ...
            it.beforeEach(function () {
                db = MYSQL_DB;
                return db.forceDropTable("dolls").then(function () {
                    db.sqls.length = 0;
                });
        ...
        it.should("provide server version", function () {
            return MYSQL_DB.serverVersion().then(function (version) {
        ...
        it.should("support forShare", function () {
            return MYSQL_DB.transaction(function () {
                return MYSQL_DB.from("test2").forShare().all().then(function (res) {
        ...
        it.should("return tinyint(1)s as boolean values and tinyint(4) as integers ", function () {
            ...
            return ds.remove()
                ...
                .then(function (res) {
                    ...
                    return ds.remove().then(function () {
                        return ds.insert({b: false, i: 10}).then(function () {
                            return ds.all();
                        });
                    });
                })
                .then(function (res) {
                    ...
                    return ds.remove().then(function () {
                        return ds.insert({b: true, i: 1}).then(function () {
                            return ds.all();
                        });
                    });
                })
        ...
        it.context(function () {
            ...
            it.should("support regexes", function () {
                return d.insert({name: "abc", value: 1})
                    ...
                    .then(function () {
                        return Promise.all([d.filter({name: /bc/}).count(), d.filter({name: /^bc/}).count()]);
                    }).then(function (res) {
        ...
        it.should("support distinct", function () {
            ...
            return db
                .forceCreateTable("a", function () {
                    ...
                    return Promise.all([ds.insert(20, 10), ds.insert(30, 10)]);
                })
                .then(function () {
                    return Promise.all([ds.order("b", "a").distinct().map("a"), ds.order("b", sql.a.desc()).distinct().map("a")]);
                })
                .then(function (res) {
        ...
        it.should("support addColumn operations", function () {
            ...
            return MYSQL_DB.addColumn("test2", "xyz", "text")
                .then(function () {
                    return Promise.all([ds.columns, ds.insert({name: "mmm", value: "111", xyz: '000'})]);
                })
                .then(function (res) {
        ...
        it.should("support renameColumn operations", function () {
            ...
            return Promise
                ...
                .then(function () {
                    return Promise.all([db.from("test2").columns, db.from("test2").first()]);
                })
                .then(function (res) {
        ...
        it.describe("A MySQL database with table options", function (it) {
            ...
            it.beforeEach(function () {
                return db.forceDropTable("items").then(function () {
                    db.sqls = [];
                });
            });
        ...
        it.describe("#stream", function (it) {
            ...
            it.beforeAll(function () {
                ...
                return MYSQL_DB.forceDropTable("items_2").then(function () {
        ...
        it.describe("date/time conversions", function (it) {
            it.should("throw an exception when a bad date/time is used and convertInvalidDateTime is false", function () {
                ...
                return MYSQL_DB.fetch("SELECT CAST('0000-00-00' AS date)").singleValue().then(assert.fail, function () {
                    return MYSQL_DB.fetch("SELECT CAST('0000-00-00 00:00:00' AS datetime)").singleValue().then(assert.fail, function () {
                        return MYSQL_DB.fetch("SELECT CAST('25:00:00' AS time)").singleValue().then(assert.fail, function () {
                            patio.mysql.convertInvalidDateTime = false;
                        });
                    });
                });
